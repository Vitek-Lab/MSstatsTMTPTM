...
# read in summarized data files (from MSstatsTMT proteinSummarization function)
...
levels(quant.msstats.ptm$Condition)
# Only compare condition 0.125 and 1
comparison<-matrix(c(-1,0,0,0,0,1),nrow=1)
# Set the names of each row
row.names(comparison)<-"6-1"
# Set the column names
colnames(comparison)<- c("1", "2", "3", "4", "5", "6")
comparison
test.contrast <- groupComparisonTMTPTM(data.ptm=quant.msstats.ptm, 
                                       data.protein=quant.msstats.protein, 
